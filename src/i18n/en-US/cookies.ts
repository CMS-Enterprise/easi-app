const cookies = {
  ...
  informationUsageTitle: 'How CMS websites use information they collect',

  informationUsageParagraphs: [
  ...
  cookiesUsageTitle: 'How CMS websites use cookies',

  cookiesUsageParagraphs: [
  ...
  cookieTypeList: [
    '<strong>Session Cookies:</strong> We use session cookies for technical purposes such as to allow better navigation through our site. These cookies let our server know that you are continuing a visit to our site. The OMB Memo 10-22 Guidance defines our use of session cookies as "Usage Tier 1: Single Session.” The policy says, "This tier encompasses any use of single session web measurement and customization technologies."',
    '<strong>Persistent Cookies:</strong> We use persistent cookies to understand the differences between new and returning CMS website visitors. Persistent cookies remain on your computer between visits to our site until they expire. The OMB Memo 10-22 Guidance defines our use of persistent cookies as "Usage Tier 2â€”Multi-session without Personally Identifiable Information (PII).â€ The policy says, "This tier encompasses any use of multi-session Web measurement and customization technologies when no PII is collected."'
  ],

  disableCookiesTitle: 'How to opt out or disable cookies',

  disableCookiesParagraph1:
  ...
  disableCookiesLink: 'http://www.usa.gov/optout_instructions.shtml',
  disableCookiesParagraph2:
    'Please note that by opting out of cookies, you will disable cookies from all sources, not just from CMS websites.',

  informationProtectionTitle: 'How we protect your personal information',

  informationProtectionParagraphs: [
  ...
  informationProtectionFurtherInfoParagraph:
    'For further information about the CMS website privacy policy, please contact ',
  informationProtectionFurtherInfoEmail: 'Privacy@cms.hhs.gov'
};
