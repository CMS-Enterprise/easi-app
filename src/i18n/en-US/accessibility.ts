...
const accessibility = {
  ...
  makingARequest: {
    ...
    info:
      'EASi is replacing Service Now for making 508 requests for applications. This means you can manage all your 508 requests for applications within EASi. For all other 508 assistance, please email the Section 508 team at CMS_Section508@cms.hhs.gov.',
    ...
    email508Team:
      'For requests related to testing COTS products, GOTS products, review of documents and training please email the Section 508 team at CMS_Section508@cms.hhs.gov.',
    ...
    noLcidBody:
      'A Lifecycle ID is your unique reference number that lets you [operate] your application. The IT governance team issues the Lifecycle ID as a part of the GRT/GRB process. Contact the IT Governance team at ITgovernanceteam@cms.hhs.gov with information about your system.'
  },
  testingTemplates: {
