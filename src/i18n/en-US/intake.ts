...
const intake = {
  ...
  csvHeadings: {
    ...
    fundingSource: 'Project Number and Investment',
  ...
  contractDetails: {
    ...
    fundingSources: {
      ...
      fundingNumberLabel: 'Project number: {{projectNumber}}',
      fundingSourcesLabel: 'Funding sources: {{investments}}',
      formLegend: '{{action}} funding source',
      errors: {
        fundingNumberMinDigits: 'Project number must be exactly 6 digits',
        fundingNumberDigits: 'Project number can only contain digits',
        fundingNumberUnique: 'Project number must be unique',
