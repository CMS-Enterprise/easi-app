const privacyPolicy = {
  ...
  infoWeCollect: {
    ...
    autoCollect: {
      ...
      whenYouBrowse: {
        ...
        description: 'Certain information about your visit can be collected when you browse websites. When you browse CMS.gov, we, and in some cases, our third-party service providers, can collect the following types of information about your visit, including:',
        ...
        additionalUsage: 'Also, this information is sometimes used to personalize the content we show you on third-party sites. For more information on our practices, see ',
      },
    },
    ...
    provided: {
      ...
      requested: {
        ...
        whyWeCollect: 'We collect information, including your email address, to deliver alerts or eNewsletters. We use this information to complete the subscription process and provide you with information. You can opt out of these communications at any time by editing your ',
  ...
  tracking: {
    ...
    adChoice: '<0>AdChoices:</0> We include the AdChoices icon on all digital advertising that uses “conversion tracking” or “retargeting.” To learn about conversion tracking, targeted advertising, and retargeting, see ',
    adChoiceIcon: '. The AdChoices icon is usually at or near the corner of digital ads. When you click on the AdChoices icon, it will provide information on what company served the ad and information on how to opt out. Learn more about AdChoices.',

    doNotTrack: '<0>Do Not Track:</0> We automatically observe the “Do Not Track” browser setting for digital advertising that uses “conversion tracking” or “retargeting.” If “Do Not Track” is set before a device visits CMS.gov, third-party conversion tracking and retargeting tools won’t load on the website. To learn more about conversion tracking and retargeting, see ',
    doNotTrackHelp: 'Learn more about Do Not Track and how to set the Do Not Track setting in your browser.',
  },
  ...
  thirdParty: {
    ...
    description: 'CMS.gov uses a variety of technologies and social media services to communicate and interact with the public. These third-party websites and applications include popular social networking and media websites, open source software communities, and more.',
    ...
    webAnalyticsTools: {
      ...
      informationCollection: 'These tools collect basic site usage information, like:',
      collectionList: [
      ...
      informationUsage: 'This information is used to maintain the website, including:',
      usageList: [
        'Monitoring website stability',
        'Measuring website traffic',
        'Optimizing website content',
  ...
  personalInfo: {
    ...
    alertsOrNews: 'You don’t have to give us personal information when you visit CMS.gov, but if you want to get alerts or e-newsletters, you’ll need to give us your email address to subscribe.',
    disclosure: 'If you choose to give us PII in an email, request for information, paper or electronic form, questionnaire, survey, etc., we’ll the information you give us only long enough to respond to your question or to fulfill the stated purpose of the communication.',

    contact: 'If we need to contact you, we’ll save your personal information in a record system designed to retrieve information about you by personal identifier (name, personal email address, home mailing address, personal or mobile phone number, etc.) and keep the information you give us safe according to the ',
    privacyAct: 'Privacy Act of 1974',
    amended: ', as amended ',
    USCSection552: '(5 U.S.C. Section 552a).',

    retrievalSystem: 'If we have a record system to retrieve information about you so we can carry out our mission, a Privacy Act Notification Statement should be prominently displayed out in the open on the public-facing website or form asking you for PII. The statement has to address these 5 criteria:',
