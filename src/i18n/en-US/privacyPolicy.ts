const privacyPolicy = {
  ...
  informationWhenYouBrowseMoreInfo: 'For more information, see ',

  informationWhenYouBrowseUsage: 'We use this information to:',
  informationWhenYouBrowseUsageList: [
  ...
  informationWhenYouBrowseAdditionalUsage: 'Also, this information is sometimes used to personalize the content we show you on third-party sites. For more information on our practices, see ',

  informationProvidedTitle: 'Information you may provide:',
  informationRequestedTitle: 'When you request information:',

  informationRequestedParagraph: 'We collect information, including your email address, to deliver alerts or eNewsletters. We use this information to complete the subscription process and provide you with information. You can opt out of these communications at any time by editing your ',
  informationRequestedSubscriptionLink: 'subscription preferences.',

  // How CMS uses information collected on CMS.gov
  informationUsageTitle: 'How CMS uses information collected on CMS.gov',
  sendingCMSMessagesTitle: 'Sending you CMS messages:',
  sendingCMSMessagesParagraph: 'We use the email address you provide us to send emails related to CMS.',

  conductingSurveysTitle: 'Conducting surveys to improve services:',
  conductingSurveysParagraph: 'We use online surveys to collect opinions and feedback. You don’t have to answer these questions. If you do answer these questions, don’t include any PII/PHI in your answers. We analyze and use the information from these surveys to improve the CMS.gov website. The information is available only to CMS managers, members of the CMS communications and web teams, and other designated federal staff and contractors who require this information to perform their duties.',

  thirdPartyAnalyticsTitle: 'Using third-party tools for website analytics',
  thirdPartyAnalyticsParagraph1: 'We use a variety of third-party web tools for web analytics. We don’t collect any PII/PHI with these tools.  We use these tools to collect basic information about visits to CMS.gov. This information is then used to maintain the website, including:',
  thirdPartyAnalyticsList: [
    'Monitoring website stability',
    'Measuring website traffic',
    'Optimizing website content',
    'Helping make the website more useful to visitors',
  ],
  thirdPartyAnalyticsParagraph2: 'CMS staff analyzes the data collected from these tools. Reports are available only to CMS managers, teams who implement programs represented on CMS.gov, members of the CMS communications and web teams, and other designated federal staff and contractors who need this information to perform their jobs.',

  thirdPartyToolsOutreachTitle: 'Using third-party tools for outreach and education through digital advertising:',

  thirdPartyToolsOutreachParagraph1: 'We use third-party web services to conduct outreach and education through the use of digital advertising for CMS.gov. These third-party services may collect information through the use of web beacons (also called pixels) that are located on our pages. A web beacon is a see-through graphic image (usually 1 pixel x 1 pixel) that\'s placed on a web page and, in combination with a cookie, allows us to collect information regarding the use of the web page that contains the web beacon.',
  thirdPartyToolsOutreachParagraph2: 'We use web beacons to tell when a user is redirected to CMS.gov by clicking or otherwise interacting with a CMS advertisement that we ran on another website. This is known as “click tracking” or “conversion tracking,” and we use it to better target CMS advertisements (known as “retargeting”) to inform consumers about the services available through CMS.gov. For more information on how these tools work, see ',
  thirdPartyToolsOutreachParagraph3: 'We also use third-party tools to help deliver advertising. Vendors that operate the third-party tools may also gather information about your visits to third-party sites outside of CMS.gov. While we don\'t track your internet activity outside of CMS.gov, our vendors may use information collected automatically by visiting CMS.gov, and combine it with data they collect elsewhere for targeted advertising purposes. You can opt out of this type of data collection via Privacy Manager, Ad Choices, and Do Not Track. For methods to opt out of this type of collection, see ',
  thirdPartyToolsOutreachParagraph4: 'The outreach and education analytics tools provide reports which aggregate data like the number of clicks on advertisements. The reports are available only to CMS managers, teams who implement programs represented on CMS.gov, members of the CMS.gov communications and web teams, and other designated federal staff and contractors who need this information to perform their duties.',

  // How CMS uses cookies & other technologies on CMS.gov
  cookiesUsageTitle: 'How CMS uses cookies & other technologies on CMS.gov',
  
  cookiesUsageParagraph1a: 'The Office of Management and Budget Memo ',
  cookiesUsageParagraph1Memo: 'M-10-22',
  cookiesUsageParagraph1b: ', Guidance for Online Use of Web Measurement and Customization Technologies, allows federal agencies to use session and persistent cookies to improve the delivery of services.',
  cookiesUsageParagraph2: 'When you visit a website, its server may generate a piece of text known as a “cookie” to place on your device. The cookie, which is unique to your browser, allows the server to "remember" specific information about your visit while you’re connected. The cookie makes it easier for you to use the dynamic features of web pages. Information that you enter into CMS.gov isn’t associated with cookies on CMS.gov. Depending on the third-party tool’s business practices, privacy policies, terms of service, and/or the privacy settings you selected, information you’ve provided to third parties could be used to identify you when you visit CMS.gov. These third parties don’t/won’t share your identity with CMS or the Department of Health and Human Services (HHS).',

  cookiesUsageParagraph3: 'There are 2 types of cookies - single session (temporary) and multi-session (persistent). Single session cookies last only as long as your internet browser is open. Once you close your browser, the session cookie disappears. Persistent cookies are stored on your device for longer periods. Both types of cookies create an ID that’s unique to your device.',
  cookieTypesList: [
    '<strong>Session cookies:</strong> We use session cookies for technical purposes, like to allow better navigation through our website. These cookies let our server know that you’re continuing a visit to our website. The OMB Memo M-10-22 Guidance defines our use of session cookies as "Usage Tier 1—Single Session.” The policy says, "This tier encompasses any use of single session web measurement and customization technologies."',
    '<strong>Persistent cookies:</strong> We use persistent cookies to understand the differences between new and returning visitors to CMS.gov. Persistent cookies remain on your device between visits to our website until they expire or are removed by the user. The OMB Memorandum M-10-22 Guidance defines our use of persistent cookies as "Usage Tier 2—Multi-session without personally identifiable information.” The policy says, "This tier encompasses any use of multi-session web measurement and customization technologies when no PII is collected." We don’t use persistent cookies to collect PII. We don’t identify a user by using cookies.',
  ],

  cookiesUsageParagraph4: 'CMS also uses these technologies on CMS.gov:',
  cookiesTechnologyList: [
    '<strong>Persistent cookies for digital advertising:</strong> Similar to persistent cookies identified above, CMS uses persistent cookies for outreach through digital advertising. These cookies can also be created on third-party websites and remain on your device between visits to our website until they expire or you remove them. Consistent with OMB guidance for “Usage Tier 2”, we don’t use persistent cookies for outreach to collect PII. CMS doesn’t identify a user by using such technologies.',
    '<strong>Web beacons for digital advertising (also called pixels and/or tracking tags):</strong> See-through images placed on certain pages of CMS.gov are typically used in conjunction with cookies and aren’t stored on your device. When you access these pages, web beacons generate a notice of your visit. For information on how we use web beacons.',
    '<strong>Website log files:</strong> These are used as an analysis tool and to tell how visitors use CMS.gov, how often they return, and how they navigate through the website.',
    '<strong>Flash:</strong> Flash is used to assess the performance of the site and as a player for selected videos depending on the browser a device is using.',
    '<strong>Local Storage Objects:</strong> We use Flash Local Storage Objects (“LSOs”) to store your preferences and to personalize your visit.',
  ],

  // Your choices about tracking & data collection on CMS.gov
  trackingTitle: 'Your choices about tracking & data collection on CMS.gov',
  trackingParagraphList: [
  ...
  adChoice1: '<strong>AdChoices:</strong> We include the AdChoices icon on all digital advertising that uses “conversion tracking” or “retargeting.” To learn about conversion tracking, targeted advertising, and retargeting, see ',
  adChoice2: '. The AdChoices icon is usually at or near the corner of digital ads. When you click on the AdChoices icon, it will provide information on what company served the ad and information on how to opt out. Learn more about AdChoices.',

  doNotTrack: '<strong>Do Not Track:</strong> We automatically observe the “Do Not Track” browser setting for digital advertising that uses “conversion tracking” or “retargeting.” If “Do Not Track” is set before a device visits CMS.gov, third-party conversion tracking and retargeting tools won’t load on the website. To learn more about conversion tracking and retargeting, see ',
  doNotTrackLink2: 'Learn more about Do Not Track and how to set the Do Not Track setting in your browser.',

  // How CMS uses third-party websites & applications with CMS.gov
  thirdPartyWebsitesAndAppsTitle: 'How CMS uses third-party websites & applications with CMS.gov',
  thirdPartyWebsitesAndAppsParagraph: 'CMS.gov uses a variety of technologies and social media services to communicate and interact with the public. These third-party websites and applications include popular social networking and media websites, open source software communities, and more.',
  thirdPartyWebsitesTitle: 'Third-party websites:',
  thirdPartyWebsitesparagraph: 'Your activity on the third-party websites that CMS.gov links to (like Facebook or Twitter) is governed by the security and privacy policies of those websites. You should review the privacy policies of all websites before using them so you understand how your information may be used.',
  webAnalyticsToolsTitle: 'Website analytics tools:',

  webAnalyticsToolsParagraph1: 'These tools collect basic site usage information, like:',
  webAnalyticsToolsList1: [
  ...
  webAnalyticsToolsParagraph2: 'This information is used to maintain the website, including:',
  webAnalyticsToolsList2: [
    'Monitoring website stability',
    'Measuring website traffic',
    'Optimizing website content',
  ...
  additionalInformationTitle: 'Additional privacy information',
  additionalInformationLink: 'Get more information about CMS privacy policies.'
