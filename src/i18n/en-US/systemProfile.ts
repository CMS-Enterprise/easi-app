const systemProfile = {
  ...
  singleSystem: {
    ...
    ato: {
      ...
      lastContingencyCompletion: 'Last Contingency Plan completion',
      lastCsrapScaDate: 'Last CSRAP* or SCA*',
      documentType: 'Document',
      doesSystemHaveDoc: 'Does this system have one?',
      ...
      csrapAcronym: 'CSRAP: Cybersecurity Risk Assessment Program',
      csrapLearnMore: 'Learn more about CSRAP',
