...
import {
  closedIntakeStatusesAdmin,
  closedIntakeStatusesV1,
  openIntakeStatusesAdmin,
  openIntakeStatusesV1,
  RequestType,
  SystemIntakeStatusV1
} from 'types/systemIntake';

export const isAdminIntakeClosed = (
  systemIntakeStatusAdmin: SystemIntakeStatusAdmin
) => closedIntakeStatusesAdmin.includes(systemIntakeStatusAdmin);

export const isAdminIntakeOpen = (
  systemIntakeStatusAdmin: SystemIntakeStatusAdmin
) => openIntakeStatusesAdmin.includes(systemIntakeStatusAdmin);
