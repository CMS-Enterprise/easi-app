...
import { showAtoExpirationDate } from 'features/Systems/SystemProfile/utils/util';
                ...
                <Grid desktop={{ col: 12 }} className="padding-0">
                  <h3 className="link-header margin-top-0 margin-bottom-2">
                    {system.cedarSoftwareProducts?.apisDeveloped === 'Yes'
                      ? t(
                          'singleSystem.systemData.apiStatusValues.apiDeveloped'
                        )
                      : t(
            ...
            <CardBody className="padding-2 padding-top-0">
              <Grid row>
                <Grid desktop={{ col: 12 }} className="padding-0">
                  ...
                  >
                    {t(
                      'singleSystem.fundingAndBudget.viewMoreBudgetAndFunding'
                    )}
                    <span aria-hidden>&nbsp;</span>
                    <span aria-hidden>&rarr; </span>
                  </UswdsReactLink>
              ...
              <Grid row>
                <Grid tablet={{ col: 6 }}>
                  <DescriptionTerm
                    ...
                    term={t(
                      'singleSystem.systemData.numberOfSystemDependencies'
                    )}
                  />
                  <DescriptionDefinition
          ...
          <Card className="grid-col-12 margin-bottom-0">
            ...
            <CardFooter className="padding-0">
              <Grid row>
                ...
                <Grid desktop={{ col: 6 }} className="padding-2">
                  <DescriptionTerm
                    term={t('singleSystem.team.contractorFTE')}
                  />
                  <DescriptionDefinition
                    className="line-height-body-3"
