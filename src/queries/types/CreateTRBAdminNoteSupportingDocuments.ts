...
export interface CreateTRBAdminNoteSupportingDocuments_createTRBAdminNoteSupportingDocuments_categorySpecificData_TRBAdminNoteGuidanceLetterCategoryData_insights {
...
export interface CreateTRBAdminNoteSupportingDocuments_createTRBAdminNoteSupportingDocuments_categorySpecificData_TRBAdminNoteGuidanceLetterCategoryData {
  ...
  insights: CreateTRBAdminNoteSupportingDocuments_createTRBAdminNoteSupportingDocuments_categorySpecificData_TRBAdminNoteGuidanceLetterCategoryData_insights[];
}
