...
export interface GetTrbAdminNotes_trbRequest_adminNotes_categorySpecificData_TRBAdminNoteGuidanceLetterCategoryData_recommendations {
...
export interface GetTrbAdminNotes_trbRequest_adminNotes_categorySpecificData_TRBAdminNoteGuidanceLetterCategoryData {
  ...
  recommendations: GetTrbAdminNotes_trbRequest_adminNotes_categorySpecificData_TRBAdminNoteGuidanceLetterCategoryData_recommendations[];
}
