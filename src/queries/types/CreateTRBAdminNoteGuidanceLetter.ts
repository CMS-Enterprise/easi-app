...
export interface CreateTRBAdminNoteGuidanceLetter_createTRBAdminNoteGuidanceLetter_categorySpecificData_TRBAdminNoteGuidanceLetterCategoryData_insights {
...
export interface CreateTRBAdminNoteGuidanceLetter_createTRBAdminNoteGuidanceLetter_categorySpecificData_TRBAdminNoteGuidanceLetterCategoryData {
  ...
  insights: CreateTRBAdminNoteGuidanceLetter_createTRBAdminNoteGuidanceLetter_categorySpecificData_TRBAdminNoteGuidanceLetterCategoryData_insights[];
}
