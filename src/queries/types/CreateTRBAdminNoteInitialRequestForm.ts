...
export interface CreateTRBAdminNoteInitialRequestForm_createTRBAdminNoteInitialRequestForm_categorySpecificData_TRBAdminNoteGuidanceLetterCategoryData_insights {
...
export interface CreateTRBAdminNoteInitialRequestForm_createTRBAdminNoteInitialRequestForm_categorySpecificData_TRBAdminNoteGuidanceLetterCategoryData {
  ...
  insights: CreateTRBAdminNoteInitialRequestForm_createTRBAdminNoteInitialRequestForm_categorySpecificData_TRBAdminNoteGuidanceLetterCategoryData_insights[];
}
