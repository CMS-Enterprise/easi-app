...
export interface CreateTRBAdminNoteGeneralRequest_createTRBAdminNoteGeneralRequest_categorySpecificData_TRBAdminNoteGuidanceLetterCategoryData_recommendations {
...
export interface CreateTRBAdminNoteGeneralRequest_createTRBAdminNoteGeneralRequest_categorySpecificData_TRBAdminNoteGuidanceLetterCategoryData {
  ...
  recommendations: CreateTRBAdminNoteGeneralRequest_createTRBAdminNoteGeneralRequest_categorySpecificData_TRBAdminNoteGuidanceLetterCategoryData_recommendations[];
}
