...
const DocumentsTable = ({ systemIntakeId, documents }: DocumentsTableProps) => {
  ...
  const columns = useMemo<Column<SystemIntakeDocument>[]>(() => {
    return [
      {
        Header: t<string>('documentsTable.fileName'),
        accessor: 'fileName'
      },
      {
        Header: t<string>('documentsTable.docType'),
      ...
      {
        Header: t<string>('documentsTable.dateAdded'),
        accessor: 'uploadedAt',
        Cell: ({ value }) => formatDateLocal(value, 'MM/dd/yyyy')
      },
      {
        Header: t<string>('documentsTable.actions'),
        accessor: ({ status }) => {
