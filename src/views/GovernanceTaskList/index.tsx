            ...
            <div className="tablet:grid-col-9">
              ...
              >
                ...
                >
                  <TaskListDescription>
                    <p className="margin-top-0">
                      Draft a business case to communicate the business need,
                      the solutions and its associated costs. Meet with the
                      Governance Review Team to discuss your draft, receive
                      feedback and refine your business case.
                    </p>
                    <p>
                      This step can take some time due to scheduling and
                      availability. You may go through multiple rounds of
                      editing your business case and receiving feedback.
                    </p>
                    {businessCaseStage && (
                      <p>
                ...
                >
                  <TaskListDescription>
                    <p className="margin-top-0">
                      The Governance Review Board will discuss and make
                      decisions based on the Business Case and recommendations
                ...
                >
                  <TaskListDescription>
                    <p className="margin-top-0">
                      If your Business Case is approved you will receive a
                      unique Lifecycle ID. If it is not approved, you would need
                      to address the concerns to proceed.
                    </p>
                  </TaskListDescription>
