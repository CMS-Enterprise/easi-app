            ...
            <HelpText className="margin-top-105">
              <>
                ...
                <ul className="margin-top-1 padding-left-205">
                  <li>
                    a detailed explanation of the business need/issue/problem
                    that the request will address
                  </li>
                  <li>
              ...
              >
                <>
                  ...
                  <ul className="margin-bottom-0">
                    <li>
                      Explore business solutions that might exist elsewhere
                      within CMS
                    </li>
                    ...
                    <li>
                      Help you explore alternatives you might not have thought
                      of
                    </li>
                    <li>
