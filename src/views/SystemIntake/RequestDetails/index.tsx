              ...
              <>
                ...
                <Form>
                  ...
                  <p className="line-height-body-6">
                    Provide a detailed explanation of the business
                    need/issue/problem that the requested project will address,
                    including any legislative mandates, regulations, etc. any
                    expected benefits from the investment of organizational
                    resources into this project. Please be sure to indicate
                    any/all relevant deadlines (e.g., statutory deadlines that
                    must meet). Explain the benefits of developing an IT for
                    this need.
                  </p>
                  <div className="tablet:grid-col-9 margin-bottom-7">
                      ...
                      <HelpText className="margin-top-105">
                        <>
                          ...
                          <ul className="margin-top-1 padding-left-205">
                            ...
                            <li>
                              any legislative mandates or regulations that needs
                              to be met
                            </li>
                            <li>
                            ...
                            <li>
                              relevant deadlines (e.g., statutory deadlines that
                              CMS must meet)
                            </li>
                            <li>
                              and the benefits of developing an IT solution for
                              this need.
                            </li>
                          </ul>
                        </>
                    ...
                    >
                      ...
                      <HelpText className="margin-top-1">
                        {`${2000 -
                          values.businessSolution.length} characters left`}
                      </HelpText>
                    </FieldGroup>
                    ...
                    >
                      <fieldset className="usa-fieldset margin-top-4">
                        <legend className="usa-label margin-bottom-1">
                          Does your request need Enterprise Architecture
                          support?
                        </legend>
                        <HelpText className="margin-bottom-1">
                          If you are unsure, mark &quot;Yes&quot; and someone
                          from the EA team will assess your needs.
                        </HelpText>
                        <FieldErrorMsg>
                          {flatErrors.needsEaSupport}
                        </FieldErrorMsg>
                        <Field
                          as={RadioField}
                        ...
                        <CollapsableLink label="How can the Enterprise Architecture team help me?">
                          <div>
                            ...
                            <ul className="margin-bottom-0">
                              ...
                              <li>
                                Give you and your team an enterprise-level view
                                of the agency to avoid duplication of projects
                              </li>
                              <li>
                    ...
                    >
                      ...
                      <HelpText className="margin-y-1">
                        ...
                        Grants Management (OAGM) track current work
                      </HelpText>
                    ...
                    >
                      <fieldset className="usa-fieldset margin-top-4">
                        <legend className="usa-label margin-bottom-1">
                          Does this request have funding from an existing
                          funding source?
                        </legend>
                        <HelpText className="margin-bottom-1">
                  ...
                  <Button
                    ...
                    outline
                    onClick={() => {
                      const newUrl = `/system/${systemId}/contact-details`;
                      history.push(newUrl);
                    }}
                  >
                    Back
                    ...
                    onClick={() => {
                      validateForm().then(err => {
                        if (Object.keys(err).length === 0) {
                          ...
                          const newUrl = `/system/${systemId}/review`;
                          history.push(newUrl);
                        }
                      });
                    }}
