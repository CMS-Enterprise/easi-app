            ...
            return (
              <>
                ...
                <p className="line-height-body-5">
                  The EASi System Intake process can guide you through all
                  stages of your project, connecting you with the resources,
                  people and services that you need. Please complete and submit
                  this CMS IT Intake form to engage with the CMS IT Governance
                  review process. This is the first step to receive a CMS IT
                  LifeCycle ID. Upon submission, you will receive an email
                  promptly from the IT_Governance mailbox, and an IT Governance
                  Team member will reach out regarding next steps.
                </p>

                <div className="tablet:grid-col-6 margin-bottom-7">
                  <Form>
                    <MandatoryFieldsAlert />
                    <h1 className="font-heading-xl margin-top-3">
                      Contact details
                    </h1>
                    ...
                    >
                      ...
                      <HelpText className="margin-bottom-105">
                        This person owns a line of business related to this
                        request and will champion the request moving forward
                      </HelpText>
                      <Field
                        as={CheckboxField}
                    ...
                    >
                      <fieldset className="usa-fieldset margin-top-4">
                        ...
                        <HelpText className="margin-bottom-2">
                          If yes, please tell us the name of your Information
                          System Security Officer so we can get in touch with
                          them
                        </HelpText>
                        <FieldErrorMsg>
                    ...
                    >
                      <fieldset className="usa-fieldset margin-top-3">
                        <legend className="usa-label margin-bottom-1">
                          For this request, I have started
                          collaborating/consulting with:
                        </legend>
                        <HelpText className="margin-bottom-2">
                          Please disclose the name of each person you&apos;ve
                          worked with. This helps us locate any additional
