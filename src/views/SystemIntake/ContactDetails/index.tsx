  ...
  useEffect(() => {
    if (systemId === 'new') {
      authService.getUser().then((user: any) => {
        ...
        const newUrl = `/system/${uuid}/contact-details`;
        history.push(newUrl);
      });
    } else {
              ...
              <>
                ...
                <Form>
                  <p className="line-height-body-6">
                    ...
                    people and services that you need. Please complete and
                    submit this CMS IT Intake form to engage with the CMS IT
                    Governance review process. This is the first step to receive
                    a CMS IT LifeCycle ID. Upon submission, you will receive an
                    email promptly from the IT_Governance mailbox, and an IT
