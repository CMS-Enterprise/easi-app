...
export type TRBAdminNoteGuidanceLetterCategoryDataFragment = { __typename: 'TRBAdminNoteGuidanceLetterCategoryData', appliesToMeetingSummary: boolean, appliesToNextSteps: boolean, insights: Array<{ __typename: 'TRBGuidanceLetterRecommendation', id: UUID, title: string, deletedAt?: Time | null }> };
