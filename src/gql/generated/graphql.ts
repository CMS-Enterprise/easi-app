...
export type SystemIntakeGRBReviewFragment = { __typename: 'SystemIntake', id: UUID, grbDate?: Time | null, grbReviewAsyncEndDate?: Time | null, grbReviewAsyncRecordingTime?: Time | null, grbReviewStartedAt?: Time | null, grbReviewType: SystemIntakeGRBReviewType, grbVotingInformation: { __typename: 'GRBVotingInformation', votingStatus: GRBVotingInformationStatus, numberOfNoObjection: number, numberOfObjection: number, numberOfNotVoted: number, grbReviewers: Array<{ __typename: 'SystemIntakeGRBReviewer', id: UUID, grbRole: SystemIntakeGRBReviewerRole, votingRole: SystemIntakeGRBReviewerVotingRole, userAccount: { __typename: 'UserAccount', id: UUID, username: string, commonName: string, email: string } }> }, grbPresentationLinks?: { __typename: 'SystemIntakeGRBPresentationLinks', recordingLink?: string | null, recordingPasscode?: string | null, transcriptFileName?: string | null, transcriptFileStatus?: SystemIntakeDocumentStatus | null, transcriptFileURL?: string | null, transcriptLink?: string | null, presentationDeckFileName?: string | null, presentationDeckFileStatus?: SystemIntakeDocumentStatus | null, presentationDeckFileURL?: string | null } | null, documents: Array<{ __typename: 'SystemIntakeDocument', id: UUID, fileName: string, version: SystemIntakeDocumentVersion, status: SystemIntakeDocumentStatus, uploadedAt: Time, url?: string | null, canView: boolean, canDelete: boolean, systemIntakeId: UUID, documentType: { __typename: 'SystemIntakeDocumentType', commonType: SystemIntakeDocumentCommonType, otherTypeDescription?: string | null } }> };
