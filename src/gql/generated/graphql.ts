...
export type GetOktaUsersQueryVariables = Exact<{
  searchTerm: Scalars['String']['input'];
}>;


export type GetOktaUsersQuery = { __typename: 'Query', searchOktaUsers: Array<{ __typename: 'UserInfo', commonName: string, email: EmailAddress, euaUserId: string }> };
...
export const GetOktaUsersDocument = gql`
...
/**
 * __useGetOktaUsersQuery__
 *
 * To run a query within a React component, call `useGetOktaUsersQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetOktaUsersQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetOktaUsersQuery({
 *   variables: {
 *      searchTerm: // value for 'searchTerm'
 *   },
 * });
 */
export function useGetOktaUsersQuery(baseOptions: Apollo.QueryHookOptions<GetOktaUsersQuery, GetOktaUsersQueryVariables> & ({ variables: GetOktaUsersQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetOktaUsersQuery, GetOktaUsersQueryVariables>(GetOktaUsersDocument, options);
      }
export function useGetOktaUsersLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetOktaUsersQuery, GetOktaUsersQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetOktaUsersQuery, GetOktaUsersQueryVariables>(GetOktaUsersDocument, options);
        }
export function useGetOktaUsersSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetOktaUsersQuery, GetOktaUsersQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetOktaUsersQuery, GetOktaUsersQueryVariables>(GetOktaUsersDocument, options);
        }
export type GetOktaUsersQueryHookResult = ReturnType<typeof useGetOktaUsersQuery>;
export type GetOktaUsersLazyQueryHookResult = ReturnType<typeof useGetOktaUsersLazyQuery>;
export type GetOktaUsersSuspenseQueryHookResult = ReturnType<typeof useGetOktaUsersSuspenseQuery>;
export type GetOktaUsersQueryResult = Apollo.QueryResult<GetOktaUsersQuery, GetOktaUsersQueryVariables>;
...
export const TypedGetOktaUsersDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetOktaUsers"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"searchTerm"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"searchOktaUsers"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"searchTerm"},"value":{"kind":"Variable","name":{"kind":"Name","value":"searchTerm"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"commonName"}},{"kind":"Field","name":{"kind":"Name","value":"email"}},{"kind":"Field","name":{"kind":"Name","value":"euaUserId"}}]}}]}}]} as unknown as DocumentNode<GetOktaUsersQuery, GetOktaUsersQueryVariables>;
