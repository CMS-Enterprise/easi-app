...
export type GetCedarSystemQuery = { __typename: 'Query', cedarSystem?: { __typename: 'CedarSystem', id: string, idAsUUID: UUID, name: string, description?: string | null, acronym?: string | null, status?: string | null, businessOwnerOrg?: string | null, businessOwnerOrgComp?: string | null, systemMaintainerOrg?: string | null, systemMaintainerOrgComp?: string | null, isBookmarked: boolean } | null };
