...
export type SystemIntakeContactFragment = { __typename: 'SystemIntakeContact', systemIntakeId: UUID, id: UUID, euaUserId: string, component: string, role: string, userAccount: { __typename: 'UserAccount', id: UUID, username: string, commonName: string, email: string } };
...
export type GetSystemIntakeContactsQuery = { __typename: 'Query', systemIntakeContacts: { __typename: 'SystemIntakeContactsPayload', systemIntakeContacts: Array<{ __typename: 'SystemIntakeContact', systemIntakeId: UUID, id: UUID, euaUserId: string, component: string, role: string, userAccount: { __typename: 'UserAccount', id: UUID, username: string, commonName: string, email: string } }> } };
