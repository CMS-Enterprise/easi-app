...
export type UpdateSystemIntakeGRBReviewPresentationMutationVariables = Exact<{
  links: SystemIntakeGRBPresentationLinksInput;
  reviewType: UpdateSystemIntakeGRBReviewTypeInput;
}>;


export type UpdateSystemIntakeGRBReviewPresentationMutation = { __typename: 'Mutation', setSystemIntakeGRBPresentationLinks?: { __typename: 'SystemIntakeGRBPresentationLinks', createdAt: Time } | null, updateSystemIntakeGRBReviewType?: { __typename: 'UpdateSystemIntakePayload', systemIntake?: { __typename: 'SystemIntake', id: UUID, grbReviewStartedAt?: Time | null, grbReviewType: SystemIntakeGRBReviewType, grbReviewers: Array<{ __typename: 'SystemIntakeGRBReviewer', id: UUID, grbRole: SystemIntakeGRBReviewerRole, votingRole: SystemIntakeGRBReviewerVotingRole, userAccount: { __typename: 'UserAccount', id: UUID, username: string, commonName: string, email: string } }>, grbPresentationLinks?: { __typename: 'SystemIntakeGRBPresentationLinks', recordingLink?: string | null, recordingPasscode?: string | null, transcriptFileName?: string | null, transcriptFileStatus?: SystemIntakeDocumentStatus | null, transcriptFileURL?: string | null, transcriptLink?: string | null, presentationDeckFileName?: string | null, presentationDeckFileStatus?: SystemIntakeDocumentStatus | null, presentationDeckFileURL?: string | null } | null } | null } | null };
...
export const UpdateSystemIntakeGRBReviewPresentationDocument = gql`
    mutation UpdateSystemIntakeGRBReviewPresentation($links: SystemIntakeGRBPresentationLinksInput!, $reviewType: updateSystemIntakeGRBReviewTypeInput!) {
  ...
  updateSystemIntakeGRBReviewType(input: $reviewType) {
    ...
    ${SystemIntakeGRBReviewFragmentDoc}`;
export type UpdateSystemIntakeGRBReviewPresentationMutationFn = Apollo.MutationFunction<UpdateSystemIntakeGRBReviewPresentationMutation, UpdateSystemIntakeGRBReviewPresentationMutationVariables>;

/**
 * __useUpdateSystemIntakeGRBReviewPresentationMutation__
 *
 * To run a mutation, you first call `useUpdateSystemIntakeGRBReviewPresentationMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useUpdateSystemIntakeGRBReviewPresentationMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [updateSystemIntakeGrbReviewPresentationMutation, { data, loading, error }] = useUpdateSystemIntakeGRBReviewPresentationMutation({
 *   variables: {
 ...
 * });
 */
export function useUpdateSystemIntakeGRBReviewPresentationMutation(baseOptions?: Apollo.MutationHookOptions<UpdateSystemIntakeGRBReviewPresentationMutation, UpdateSystemIntakeGRBReviewPresentationMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateSystemIntakeGRBReviewPresentationMutation, UpdateSystemIntakeGRBReviewPresentationMutationVariables>(UpdateSystemIntakeGRBReviewPresentationDocument, options);
      }
export type UpdateSystemIntakeGRBReviewPresentationMutationHookResult = ReturnType<typeof useUpdateSystemIntakeGRBReviewPresentationMutation>;
export type UpdateSystemIntakeGRBReviewPresentationMutationResult = Apollo.MutationResult<UpdateSystemIntakeGRBReviewPresentationMutation>;
export type UpdateSystemIntakeGRBReviewPresentationMutationOptions = Apollo.BaseMutationOptions<UpdateSystemIntakeGRBReviewPresentationMutation, UpdateSystemIntakeGRBReviewPresentationMutationVariables>;
