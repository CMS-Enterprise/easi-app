...
export type GetCedarSubSystemsQuery = { __typename: 'Query', cedarSubSystems: Array<{ __typename: 'CedarSubSystem', id: UUID, name: string, acronym?: string | null, description?: string | null }> };
