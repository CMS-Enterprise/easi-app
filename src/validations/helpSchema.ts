 ...
 */
export const sendFeedbackEmailInputSchema: Yup.SchemaOf<SendFeedbackEmailInput> =
  Yup.object({
 ...
 */
export const sendFeedbackEmailFormSchema: Yup.SchemaOf<SendFeedbackEmailForm> =
  sendFeedbackEmailInputSchema.concat(
    Yup.object({
      ...
      questionsWereRelevant: Yup.string()
        ...
        .oneOf(
          getFeedbackOptionValues(
            sendFeedbackOptionFields.questionsWereRelevant
          ),
          msgSelect
        )
        .required(),
...
export const sendReportAProblemEmailInputSchema: Yup.SchemaOf<SendReportAProblemEmailInput> =
  Yup.object({
    isAnonymous: Yup.boolean().required(),
    canBeContacted: Yup.boolean().required(),
...
export const sendReportAProblemEmailFormSchema: Yup.SchemaOf<SendReportAProblemEmailForm> =
  sendReportAProblemEmailInputSchema.concat(
    Yup.object({
      isAnonymous: Yup.boolean().nullable().default(null).required(msgSelect),
