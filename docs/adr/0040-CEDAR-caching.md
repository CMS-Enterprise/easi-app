...
**Superseded:** The nginx caching proxy described below was decommissioned in 2026 ([EASI-5051](https://jiraent.cms.gov/browse/EASI-5051)) after being bypassed via a runtime flag for about a year. It improved response times, but it also masked upstream CEDAR API issues. EASi now calls CEDAR directly; this ADR is kept for historical context.
