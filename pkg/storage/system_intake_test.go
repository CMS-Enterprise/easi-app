...
func NewSystemIntake() models.SystemIntake {
	return models.SystemIntake{
		...
		BidnessOwner:            null.StringFrom("Test Bidness Owner"),
		BidnessOwnerComponent:   null.StringFrom("Test Bidness Owner Component"),
		...
		BidnessNeed:             null.StringFrom("Test Bidness Need"),
