...
func CreateSystemIntake(ctx context.Context, np sqlutils.NamedPreparer, intake *models.SystemIntake) (*models.SystemIntake, error) {
	...
	const createIntakeSQL = `
		INSERT INTO system_intakes (
			...
			current_estimated_cost_it_portion,
			planned_year_one_spending,
			planned_year_one_spending_it_portion,
			estimated_total_contract_value,
			estimated_total_contract_value_it_portion,
			contractor,
			contract_vehicle,
...
func (s *Store) UpdateSystemIntakeNP(ctx context.Context, np sqlutils.NamedPreparer, intake *models.SystemIntake) (*models.SystemIntake, error) {
	...
	const updateSystemIntakeSQL = `
		...
		SET
			...
			current_estimated_cost_it_portion = :current_estimated_cost_it_portion,
			...
			estimated_total_contract_value_it_portion = :estimated_total_contract_value_it_portion,
			...
			governance_teams_is_present = :governance_teams_is_present
