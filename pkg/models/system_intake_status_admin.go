...
const (
	...
	SISADraftBusinessCaseComplete    SystemIntakeStatusAdmin = "DRAFT_BUSINESS_CASE_COMPLETE"
	...
	SISAFinalBusinessCaseComplete    SystemIntakeStatusAdmin = "FINAL_BUSINESS_CASE_COMPLETE"
