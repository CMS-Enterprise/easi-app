...
type TRBRequestForm struct {
	...
	SubjectAreaTechnicalReferenceArchitectureOther *string                  `json:"subjectAreaTechnicalReferenceArchitectureOther" db:"subject_area_technical_reference_architecture_other"`
	SubjectAreaNetworkAndSecurityOther             *string                  `json:"subjectAreaNetworkAndSecurityOther" db:"subject_area_network_and_security_other"`
	SubjectAreaCloudAndInfrastructureOther         *string                  `json:"subjectAreaCloudAndInfrastructureOther" db:"subject_area_cloud_and_infrastructure_other"`
	SubjectAreaApplicationDevelopmentOther         *string                  `json:"subjectAreaApplicationDevelopmentOther" db:"subject_area_application_development_other"`
