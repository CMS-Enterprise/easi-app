...
type SystemIntake struct {
	...
	RequestFormState            SystemIntakeRequestFormState       `json:"requestFormState" db:"request_form_state"`
	DraftBusinessCaseState      SystemIntakeDraftBusinessCaseState `json:"draftBusinessCaseState" db:"draft_business_case_state"`
	FinalBusinessCaseState      SystemIntakeFinalBusinessCaseState `json:"finalBusinessCaseState" db:"final_business_case_state"`
...
// SystemIntakeRequestFormState represents the types of SystemIntakeRequestFormState types.
type SystemIntakeRequestFormState string

// These are the options for SystemIntakeRequestFormState
const (
	SIRFSNotStarted     SystemIntakeRequestFormState = "NOT_STARTED"
	SIRFSInProgress     SystemIntakeRequestFormState = "IN_PROGRESS"
	SIRFSEditsRequested SystemIntakeRequestFormState = "EDITS_REQUESTED"
	SIRFSSubmitted      SystemIntakeRequestFormState = "SUBMITTED"
)

// SystemIntakeDraftBusinessCaseState represents the types of SystemIntakeDraftBusinessCaseState types.
type SystemIntakeDraftBusinessCaseState string

// These are the options for SystemIntakeDraftBusinessCaseState
const (
	SIDBCSNotStarted     SystemIntakeDraftBusinessCaseState = "NOT_STARTED"
	SIDBCSInProgress     SystemIntakeDraftBusinessCaseState = "IN_PROGRESS"
	SIDBCSEditsRequested SystemIntakeDraftBusinessCaseState = "EDITS_REQUESTED"
	SIDBCSSubmitted      SystemIntakeDraftBusinessCaseState = "SUBMITTED"
)

// SystemIntakeFinalBusinessCaseState represents the types of SystemIntakeFinalBusinessCaseState types.
type SystemIntakeFinalBusinessCaseState string

// These are the options for SystemIntakeFinalBusinessCaseState
const (
	SIFBCSNotStarted     SystemIntakeFinalBusinessCaseState = "NOT_STARTED"
	SIFBCSInProgress     SystemIntakeFinalBusinessCaseState = "IN_PROGRESS"
	SIFBCSEditsRequested SystemIntakeFinalBusinessCaseState = "EDITS_REQUESTED"
	SIFBCSSubmitted      SystemIntakeFinalBusinessCaseState = "SUBMITTED"
)
