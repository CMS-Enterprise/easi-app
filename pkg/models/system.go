...
// BusinessOwner represents business owner that is associated with a system
type BusinessOwner struct {
	Name      string `json:"name" db:"business_owner"`
	Component string `json:"component" db:"business_owner_component"`
}
