...
func (s *ModelTestSuite) TestSystemIntakeGRBDiscussionsHelpers() {
	...
	post1ID := uuid.New()
	post1.ID = post1ID
	post1.DiscussionBoardType = new(SystemIntakeGRBDiscussionBoardTypePrimary)

	// replies
	post1reply1 := NewSystemIntakeGRBReviewDiscussionPost(createdByID)
	post1reply1.DiscussionBoardType = new(SystemIntakeGRBDiscussionBoardTypePrimary)
	...
	post1reply2.DiscussionBoardType = new(SystemIntakeGRBDiscussionBoardTypePrimary)
	...
	post2ID := uuid.New()
	post2.ID = post2ID
	post2.DiscussionBoardType = new(SystemIntakeGRBDiscussionBoardTypePrimary)

	// replies
	post2reply1 := NewSystemIntakeGRBReviewDiscussionPost(createdByID)
	post2reply1.DiscussionBoardType = new(SystemIntakeGRBDiscussionBoardTypePrimary)
	...
	post2reply2.DiscussionBoardType = new(SystemIntakeGRBDiscussionBoardTypePrimary)
