...
const (
	// This step can't be started yet
	ITGovDraftBusinessCaseStatusCantStart ITGovDraftBusinessCaseStatus = "CANT_START"
	// This step is no longer needed
	ITGovDraftBusinessCaseStatusNotNeeded ITGovDraftBusinessCaseStatus = "NOT_NEEDED"
	// Ready to begin filling out
	ITGovDraftBusinessCaseStatusReady ITGovDraftBusinessCaseStatus = "READY"
	// The form has started to be filled out
	ITGovDraftBusinessCaseStatusInProgress ITGovDraftBusinessCaseStatus = "IN_PROGRESS"
	// This draft business case has edits requested
	ITGovDraftBusinessCaseStatusEditsRequested ITGovDraftBusinessCaseStatus = "EDITS_REQUESTED"
	// The draft business case has been submitted and it is waiting for feedback from the governance team
	ITGovDraftBusinessCaseStatusSubmitted ITGovDraftBusinessCaseStatus = "SUBMITTED"
	// The draft business case has been completed and the intake is on a further step
	ITGovDraftBusinessCaseStatusDone ITGovDraftBusinessCaseStatus = "DONE"
)

var AllITGovDraftBusinessCaseStatus = []ITGovDraftBusinessCaseStatus{
	ITGovDraftBusinessCaseStatusCantStart,
	ITGovDraftBusinessCaseStatusNotNeeded,
	ITGovDraftBusinessCaseStatusReady,
	ITGovDraftBusinessCaseStatusInProgress,
	ITGovDraftBusinessCaseStatusEditsRequested,
	ITGovDraftBusinessCaseStatusSubmitted,
	ITGovDraftBusinessCaseStatusDone,
}

func (e ITGovDraftBusinessCaseStatus) IsValid() bool {
	switch e {
	case ITGovDraftBusinessCaseStatusCantStart, ITGovDraftBusinessCaseStatusNotNeeded, ITGovDraftBusinessCaseStatusReady, ITGovDraftBusinessCaseStatusInProgress, ITGovDraftBusinessCaseStatusEditsRequested, ITGovDraftBusinessCaseStatusSubmitted, ITGovDraftBusinessCaseStatusDone:
		return true
	}
	return false
}

func (e ITGovDraftBusinessCaseStatus) String() string {
	return string(e)
}

func (e *ITGovDraftBusinessCaseStatus) UnmarshalGQL(v interface{}) error {
	str, ok := v.(string)
	if !ok {
		return fmt.Errorf("enums must be strings")
	}

	*e = ITGovDraftBusinessCaseStatus(str)
	if !e.IsValid() {
		return fmt.Errorf("%s is not a valid ITGovDraftBusinessCaseStatus", str)
	}
	return nil
}

func (e ITGovDraftBusinessCaseStatus) MarshalGQL(w io.Writer) {
	fmt.Fprint(w, strconv.Quote(e.String()))
}
...
const (
	// This step can't be started yet
	ITGovFeedbackStatusCantStart ITGovFeedbackStatus = "CANT_START"
	// This step is in review
	ITGovFeedbackStatusInReview ITGovFeedbackStatus = "IN_REVIEW"
	// The step is completed
	ITGovFeedbackStatusCompleted ITGovFeedbackStatus = "COMPLETED"
)

var AllITGovFeedbackStatus = []ITGovFeedbackStatus{
	ITGovFeedbackStatusCantStart,
	ITGovFeedbackStatusInReview,
	ITGovFeedbackStatusCompleted,
}

func (e ITGovFeedbackStatus) IsValid() bool {
	switch e {
	case ITGovFeedbackStatusCantStart, ITGovFeedbackStatusInReview, ITGovFeedbackStatusCompleted:
		return true
	}
	return false
}

func (e ITGovFeedbackStatus) String() string {
	return string(e)
}

func (e *ITGovFeedbackStatus) UnmarshalGQL(v interface{}) error {
	str, ok := v.(string)
	if !ok {
		return fmt.Errorf("enums must be strings")
	}

	*e = ITGovFeedbackStatus(str)
	if !e.IsValid() {
		return fmt.Errorf("%s is not a valid ITGovFeedbackStatus", str)
	}
	return nil
}

func (e ITGovFeedbackStatus) MarshalGQL(w io.Writer) {
	fmt.Fprint(w, strconv.Quote(e.String()))
}
...
const (
	// This step can't be started yet
	ITGovGRBStatusCantStart ITGovGRBStatus = "CANT_START"
	// This step is not needed and has been skipped
	ITGovGRBStatusNotNeeded ITGovGRBStatus = "NOT_NEEDED"
	// The GRB meeting is waiting to be scheduled
	ITGovGRBStatusReadyToSchedule ITGovGRBStatus = "READY_TO_SCHEDULE"
	// The GRB meeting has been scheduled
	ITGovGRBStatusScheduled ITGovGRBStatus = "SCHEDULED"
	// The GRT meeting has already happened, and an outcome hasn't been noted yet
	ITGovGRBStatusAwaitingDecision ITGovGRBStatus = "AWAITING_DECISION"
	// The step is completed
	ITGovGRBStatusCompleted ITGovGRBStatus = "COMPLETED"
)

var AllITGovGRBStatus = []ITGovGRBStatus{
	ITGovGRBStatusCantStart,
	ITGovGRBStatusNotNeeded,
	ITGovGRBStatusReadyToSchedule,
	ITGovGRBStatusScheduled,
	ITGovGRBStatusAwaitingDecision,
	ITGovGRBStatusCompleted,
}

func (e ITGovGRBStatus) IsValid() bool {
	switch e {
	case ITGovGRBStatusCantStart, ITGovGRBStatusNotNeeded, ITGovGRBStatusReadyToSchedule, ITGovGRBStatusScheduled, ITGovGRBStatusAwaitingDecision, ITGovGRBStatusCompleted:
		return true
	}
	return false
}

func (e ITGovGRBStatus) String() string {
	return string(e)
}

func (e *ITGovGRBStatus) UnmarshalGQL(v interface{}) error {
	str, ok := v.(string)
	if !ok {
		return fmt.Errorf("enums must be strings")
	}

	*e = ITGovGRBStatus(str)
	if !e.IsValid() {
		return fmt.Errorf("%s is not a valid ITGovGRBStatus", str)
	}
	return nil
}

func (e ITGovGRBStatus) MarshalGQL(w io.Writer) {
	fmt.Fprint(w, strconv.Quote(e.String()))
}
