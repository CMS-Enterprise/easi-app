...
// NewHTTPClientWithConfig creates a new c e d a r intake HTTP client,
// using a customizable transport config.
func NewHTTPClientWithConfig(formats strfmt.Registry, cfg *TransportConfig) *CEDARIntake {
...
// New creates a new c e d a r intake client
func New(transport runtime.ClientTransport, formats strfmt.Registry) *CEDARIntake {
	// ensure nullable parameters have default
	if formats == nil {
	...
	cli.Intake = intake.New(transport, formats)
	return cli
}
...
// CEDARIntake is a client for c e d a r intake
type CEDARIntake struct {
	HealthCheck health_check.ClientService

	Intake intake.ClientService

	Transport runtime.ClientTransport
}

// SetTransport changes the transport on the client and all its subresources
func (c *CEDARIntake) SetTransport(transport runtime.ClientTransport) {
	c.Transport = transport
	c.HealthCheck.SetTransport(transport)
	c.Intake.SetTransport(transport)
}
