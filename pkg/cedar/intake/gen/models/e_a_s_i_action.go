...
// ContextValidate validates this e a s i action based on context it is used
func (m *EASIAction) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
