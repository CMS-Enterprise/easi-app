...
type EASIIntake struct {
	...
	EaSupportRequest            string `json:"eaSupportRequest,omitempty" jsonschema:"enum=,enum=false,enum=true,description=Does the request need EA support,example=True"`
	...
	ExistingFunding             string `json:"existingFunding,omitempty" jsonschema:"enum=,enum=false,enum=true,description=Will this project be funded out of an existing source,example=True"`
