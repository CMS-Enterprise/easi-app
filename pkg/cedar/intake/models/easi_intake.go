...
type EASIIntake struct {
	...
	ArchivedAt                  *string              `json:"archivedAt,omitempty" jsonschema:"description=Timestamp of when request was archived,example=2022-02-17T14:34:43Z,format=date-time"`
	...
	ContractEndDate             *string              `json:"contractEndDate,omitempty" jsonschema:"description=The contract's end date,example=2026-10-20,format=date"`
	ContractStartDate           *string              `json:"contractStartDate,omitempty" jsonschema:"description=The contract's start date,example=2022-10-20,format=date"`
	...
	DecidedAt                   *string              `json:"decidedAt,omitempty" jsonschema:"description=Timestamp of when decision was reached,example=2022-02-17T14:34:43Z,format=date-time"`
	...
	GrbDate                     *string              `json:"grbDate,omitempty" jsonschema:"description=Scheduled date for the Governance Review Board (GRB) meeting,example=2025-12-12,format=date"`
	GrtDate                     *string              `json:"grtDate,omitempty" jsonschema:"description=Scheduled date for the Governance Review Team (GRT) meeting,example=2025-10-20,format=date"` // TODO: doesn't seem like this is ever populated, remove?
	...
	LifecycleExpiresAt          *string              `json:"lifecycleExpiresAt,omitempty" jsonschema:"description=Expiration date for the LCID associated with this request,example=2030-12-23,format=date"`
	...
	SubmittedAt                 string               `json:"submittedAt" jsonschema:"description=Timestamp of when request was submitted,example=2022-02-17T14:34:43Z,format=date-time"`
