...
type EASIBizCase struct {
	ArchivedAt           string                  `json:"archivedAt" jsonschema:"description=Timestamp of when request was archived,example=2023-02-27 14:34:43.405934+00"`
	...
	InitialSubmittedAt   string                  `json:"initialSubmittedAt" jsonschema:"description=Timestamp of when request was initially submitted,example=2022-02-17 07:34:43.405934+00"`
	...
	LastSubmittedAt      string                  `json:"lastSubmittedAt" jsonschema:"description=Timestamp of when request was last submitted,example=2022-02-11 16:34:43.405934+00"`
	...
	RequesterPhoneNumber string                  `json:"requesterPhoneNumber" jsonschema:"description=Phone number of requester,example=410-123-4567"`
	SubmittedAt          string                  `json:"submittedAt" jsonschema:"description=Timestamp of when request was submitted,example=2022-02-10 19:34:43.405934+00"`
...
type EASILifecycleCost struct {
	...
	Phase          string `json:"phase" jsonschema:"description=Type of work to be performed (can be more then one),example=Development and Operations and Maintenance"`
