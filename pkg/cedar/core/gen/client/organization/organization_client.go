...
func (a *Client) OrganizationFindList(params *OrganizationFindListParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*OrganizationFindListOK, error) {
	...
	if params == nil {
		params = NewOrganizationFindListParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "organizationFindList",
		Method:             "GET",
		...
		Params:             params,
		Reader:             &OrganizationFindListReader{formats: a.formats},
		AuthInfo:           authInfo,
	...
	success, ok := result.(*OrganizationFindListOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for organizationFindList: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
