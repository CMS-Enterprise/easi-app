...
func (m *UserFindResponse) validateUsers(formats strfmt.Registry) error {
...
func (m *UserFindResponse) validateCount(formats strfmt.Registry) error {
...
func (m *UserFindResponse) contextValidateUsers(ctx context.Context, formats strfmt.Registry) error {
