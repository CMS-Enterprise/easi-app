...
// PageSystemMaintainer page system maintainer
//
// swagger:model PageSystemMaintainer
type PageSystemMaintainer struct {
...
// Validate validates this page system maintainer
func (m *PageSystemMaintainer) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PageSystemMaintainer) validateID(formats strfmt.Registry) error {
...
func (m *PageSystemMaintainer) validateMajorRefreshDate(formats strfmt.Registry) error {
...
func (m *PageSystemMaintainer) validateNextMajorRefreshDate(formats strfmt.Registry) error {
...
func (m *PageSystemMaintainer) validateSystemProductionDate(formats strfmt.Registry) error {
...
func (m *PageSystemMaintainer) validateVersion(formats strfmt.Registry) error {
...
// ContextValidate validates this page system maintainer based on context it is used
func (m *PageSystemMaintainer) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *PageSystemMaintainer) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *PageSystemMaintainer) UnmarshalBinary(b []byte) error {
	var res PageSystemMaintainer
