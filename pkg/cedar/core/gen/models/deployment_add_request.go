...
func (m *DeploymentAddRequest) validateDeployments(formats strfmt.Registry) error {
...
func (m *DeploymentAddRequest) contextValidateDeployments(ctx context.Context, formats strfmt.Registry) error {
