...
func (m *OrganizationFindResponse) validateOrganizations(formats strfmt.Registry) error {
...
func (m *OrganizationFindResponse) validateCount(formats strfmt.Registry) error {
...
func (m *OrganizationFindResponse) contextValidateOrganizations(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OrganizationFindResponse) UnmarshalBinary(b []byte) error {
	var res OrganizationFindResponse
