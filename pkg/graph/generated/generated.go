...
type ComplexityRoot struct {
	...
	Mutation struct {
		...
		CreateSystemIntakeNote                           func(childComplexity int, inout *model.CreateSystemIntakeNote) int
...
type MutationResolver interface {
	...
	CreateSystemIntakeNote(ctx context.Context, inout *model.CreateSystemIntakeNote) (*model.UpdateSystemIntakePayload, error)
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Mutation.createSystemIntakeNote":
		...
		return e.complexity.Mutation.CreateSystemIntakeNote(childComplexity, args["inout"].(*model.CreateSystemIntakeNote)), true
...
type Mutation {
  ...
  createSystemIntakeNote(inout: CreateSystemIntakeNote): UpdateSystemIntakePayload @hasRole(role: EASI_GOVTEAM)
...
func (ec *executionContext) field_Mutation_createSystemIntakeNote_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	var err error
	args := map[string]interface{}{}
	var arg0 *model.CreateSystemIntakeNote
	if tmp, ok := rawArgs["inout"]; ok {
		ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("inout"))
		arg0, err = ec.unmarshalOCreateSystemIntakeNote2ᚖgithubᚗcomᚋcmsgovᚋeasiᚑappᚋpkgᚋgraphᚋmodelᚐCreateSystemIntakeNote(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Mutation_createSystemIntakeNote(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		directive0 := func(rctx context.Context) (interface{}, error) {
			ctx = rctx // use context from middleware stack in children
			return ec.resolvers.Mutation().CreateSystemIntakeNote(rctx, args["inout"].(*model.CreateSystemIntakeNote))
		}
		directive1 := func(ctx context.Context) (interface{}, error) {
			role, err := ec.unmarshalNRole2githubᚗcomᚋcmsgovᚋeasiᚑappᚋpkgᚋgraphᚋmodelᚐRole(ctx, "EASI_GOVTEAM")
			if err != nil {
...
func (ec *executionContext) unmarshalInputCreateSystemIntakeNote(ctx context.Context, obj interface{}) (model.CreateSystemIntakeNote, error) {
	var it model.CreateSystemIntakeNote
	var asMap = obj.(map[string]interface{})
...
func (ec *executionContext) _Mutation(ctx context.Context, sel ast.SelectionSet) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "rejectIntake":
			out.Values[i] = ec._Mutation_rejectIntake(ctx, field)
...
func (ec *executionContext) unmarshalOCreateSystemIntakeNote2ᚖgithubᚗcomᚋcmsgovᚋeasiᚑappᚋpkgᚋgraphᚋmodelᚐCreateSystemIntakeNote(ctx context.Context, v interface{}) (*model.CreateSystemIntakeNote, error) {
	if v == nil {
		return nil, nil
	}
	res, err := ec.unmarshalInputCreateSystemIntakeNote(ctx, v)
	return &res, graphql.ErrorOnPath(ctx, err)
}
