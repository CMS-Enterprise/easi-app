...
func (r *mutationResolver) RestartGRBReviewAsync(ctx context.Context, systemIntakeID uuid.UUID) (*models.UpdateSystemIntakePayload, error) {
	return resolvers.RestartGRBReviewAsync(ctx, r.store, systemIntakeID)
}
