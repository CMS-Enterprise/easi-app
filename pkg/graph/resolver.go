...
type ResolverService struct {
	...
	AddGRTFeedback                func(context.Context, *models.GovernanceRequestFeedback, *models.Action, *models.EmailNotificationRecipients) (*models.GovernanceRequestFeedback, error)
	CreateActionUpdateStatus      func(context.Context, *models.Action, uuid.UUID, bool, *models.EmailNotificationRecipients) (*models.SystemIntake, error)
