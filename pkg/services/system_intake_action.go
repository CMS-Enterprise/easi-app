...
func NewCreateSystemIntakeAction(
	...
	submitDraftBusinessCase func(context.Context, *models.SystemIntake, *models.Action) error,
	...
	return func(ctx context.Context, action *models.Action) error {
		...
		case models.ActionTypeSUBMITDRAFTBIZCASE:
			return submitDraftBusinessCase(ctx, intake, action)
		default:
