...
ALTER TYPE system_intake_document_type ADD VALUE 'SOFTWARE_BILL_OF_MATERIALS' AFTER 'REQUEST_FOR_ADDITIONAL_FUNDING';
ALTER TYPE system_intake_document_type ADD VALUE 'MEETING_MINUTES' AFTER 'SOFTWARE_BILL_OF_MATERIALS';
