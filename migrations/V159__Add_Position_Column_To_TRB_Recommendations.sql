/*
This migration allows us to track the position/ordering of multiple insights attached to a TRB advice letter,
...
which would guarantee that all insights on a single request/letter have a distinct position,
